...
public class ContactPanel extends javax.swing.JPanel {
    ...
    public ContactPanel(User user, Contact contact)
    {
        this.user = user;
    ...
    private void initComponents() {
        ...
        contactNameLabel.setText("Evan Smitherson");
    ...
    private void formMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_formMousePressed
        ...
        new ContactDetails(user, contact).setVisible(true);
         
    }//GEN-LAST:event_formMousePressed

    //sets the contact's name label and gets a scaled instance of the contact's image for the panel
