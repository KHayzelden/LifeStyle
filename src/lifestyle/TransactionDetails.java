...
public class TransactionDetails extends javax.swing.JFrame {
    ...
    public TransactionDetails(User user, Transaction transaction)
    {
        this.user = user;
        ...
        mainLabel.setText("New Transaction");
        
        saveButton.setText("Save Transaction");
        deleteButton.setText("Discard Transaction");
    ...
    public TransactionDetails(User user)
    {
        this.user = user;
        ...
        mainLabel.setText("Transaction Details");
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(464, 349));
        setMinimumSize(new java.awt.Dimension(464, 349));
        setPreferredSize(new java.awt.Dimension(464, 349));
        setResizable(false);
        setSize(new java.awt.Dimension(464, 349));
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(saveButton, javax.swing.GroupLayout.DEFAULT_SIZE, 430, Short.MAX_VALUE)
                    .addComponent(deleteButton, javax.swing.GroupLayout.DEFAULT_SIZE, 430, Short.MAX_VALUE)
                    .addGroup(mainPanelLayout.createSequentialGroup()
                        .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(dateLabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 104, Short.MAX_VALUE)
        ...
        mainPanelLayout.setVerticalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(incomeLabel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(backgroundPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 352, Short.MAX_VALUE)
        );

        setSize(new java.awt.Dimension(464, 374));
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        else
        {
            ...
            user.finances.removeTransaction(transaction);
    ...
    private void saveButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveButtonActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "All fields are reuqired.");
        }
        else
        {
            try
            {
                ...
                if (newItem)
                {
                    user.finances.addTransaction(newTransaction);
                    
                    this.dispose();
                }
                else
                {
                    user.finances.updateTransaction(transaction, newTransaction);
